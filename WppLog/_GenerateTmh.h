...
//Name of the logger is the WppLogGuid and the GUID is {577C26C1-1F1E-4257-8D0C-115E54ED2DF1}
#define WPP_CONTROL_GUIDS \
    WPP_DEFINE_CONTROL_GUID( WppLogGuid , (577C26C1 , 1F1E , 4257 , 8D0C , 115E54ED2DF1) , \
    WPP_DEFINE_BIT(DBG_TEST)                            \
    WPP_DEFINE_BIT(DBG_DLL_INJECT_MGR)                  \
    WPP_DEFINE_BIT(DBG_DLL_INJECT_MGR_HELPER)           \
    WPP_DEFINE_BIT(DBG_OPENGL_HANDLER)                  \
